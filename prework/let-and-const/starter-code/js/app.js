...
let allProducts = []; //changed from const
...
function displayPics(){
  ...
  // Because the scope of let is limited to the {} of the while loop, and we console logged it outside of its scope, unlike var
  console.log(viewed);
