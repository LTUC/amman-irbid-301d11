...
//It is undefined because the code runs in strict mode. 
// 2. What is "this" when joe.scopeArrow() is invoked?
//The this inside of the function logs the object but the one outside it logs undefined
// 3. Explain why "this" is different when an arrow function is used.
//Because in the arrow function this is limited to the scope of the {}.